...
#' fig_metanetwork()
fig_metanetwork_ceascf <- function() {
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  # Data
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  cekm <- read.csv(here::here("data", "ceascf", "data-output", "cumulative_effects_cv_km2.csv"))
  ...
  cv$title[cv$title == "Sites d’intérêt"] <- "Sites d’intérêt"
  ...
  insertRow <- function(dat, uid, group, network) {
    ...
    newrow <- data.frame(
      group = group, network = network, name = randomString(),
  ...
  nodesTx <- insertRow(nodesTx, uid, "Sites d’intérêt", "Public")
  ...
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  png(
    here::here("figures", "ceascf", "figures-output", "cumulative_effects_metanetwork.png"),
