...
fig_regional_contribution_ceascf <- function() {
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  # Data
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  ...
  png(
    here::here("figures", "ceascf", "figures-output", "cumulative_effects_regional_contribution.png"),
    res = 300, width = 400, height = 225, units = "mm"
  )
